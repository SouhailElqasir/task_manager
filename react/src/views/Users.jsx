                    ...
                    user.isadmin === 1 ? (
                        <div>
                            <Link to="/users/new" className="button">
                                <span className="button__text">Add new user</span>
                        ...
                        <tbody>
                            {users.map(u => (
                                <tr key={u.id}>
                                    ...
                                    {user.isadmin === 1 ? (
                                        <td>
                                            <Link className="btn-edit" to={'/users/' + u.id}><FontAwesomeIcon icon={faPen} /></Link>
                                            &nbsp;
                                            <button class="tooltip" onClick={ev => onDeleteClick(u)}>
